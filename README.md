...
Статистика StackOverflow неумолимо указывает, что VBA — один из худших языков для разработки программных продуктов.

Бросаются в глаза отсутствие наследования, конструктора в классах, невозможность инициализации переменной при её объявлении и нехватка волшебного LINQ.
